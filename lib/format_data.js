...
MSTeamsFormatter.prototype.formatData = function(data) {
  this.robot.logger.info("Got data in formatData: " + JSON.stringify(data));
...
MSTeamsFormatter.prototype.formatRecepient = function(recepient) {
  this.robot.logger.info("Got recipient in formatRecepient: " + JSON.stringify(recepient));
  return recepient;
};

MSTeamsFormatter.prototype.normalizeCommand = function (command) {
  this.robot.logger.info("Got command in normalizeCommand: " + JSON.stringify(command));
  return command;
}
